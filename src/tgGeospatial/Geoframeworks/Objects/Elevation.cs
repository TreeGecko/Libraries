...
namespace TreeGecko.Library.Geospatial.Geoframeworks.Objects
{
    ...
    public struct Elevation : IFormattable, IComparable<Elevation>, IEquatable<Elevation>, ICloneable<Elevation>, IXmlSerializable
    {
        ...
        {
            m_DecimalDegrees = ToDecimalDegrees(hours);
        }
        ...
        {
            m_DecimalDegrees = ToDecimalDegrees(hours, decimalMinutes);
        }
        ...
        {
            m_DecimalDegrees = ToDecimalDegrees(hours, minutes, seconds);
        }
            ...
            try
            {
                ...
                switch (Values.Length)
                {
                    ...
                    case 1: // Decimal degrees
                        ...
                        {
                            m_DecimalDegrees = double.Parse(Values[0], culture);
                            return;
                        }
        ...
        {
            get { return m_DecimalDegrees >= -90 && m_DecimalDegrees <= 90; }
        }
        ...
        public Elevation Normalize()
        {
            ...
            if (double.IsInfinity(m_DecimalDegrees)
                || double.IsNaN(m_DecimalDegrees)
                || IsNormalized)
                return this;
        ...
        {
            return new Elevation(Math.Round(m_DecimalDegrees, decimals));
        }
        ...
        {
            return new Elevation(m_DecimalDegrees + 180.0).Normalize();
        }
        ...
        {
            return new Elevation(m_DecimalDegrees + 1.0);
        }
        ...
        {
            return new Elevation(m_DecimalDegrees);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            if (reader.NodeType == XmlNodeType.Text)
                m_DecimalDegrees = reader.ReadContentAsDouble();
            else
