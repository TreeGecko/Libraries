...
using TreeGecko.Library.Geospatial.Geoframeworks.Interfaces;
using TreeGecko.Library.Geospatial.Properties;
...
namespace TreeGecko.Library.Geospatial.Geoframeworks.Objects
{
    ...
    {      
        ...
        public Angle(double _decimalDegrees)
        {
            // Set the decimal degrees value
            m_DecimalDegrees = _decimalDegrees;
        }
        ...
        /// and 360.
        /// </param>
        public Angle(int _hours)
        {
            m_DecimalDegrees = ToDecimalDegrees(_hours);
        }
        ...
        /// </example>
        /// <returns>An <strong>Angle</strong> containing the specified value.</returns>
        public Angle(int _hours, int _minutes, double _seconds)
        {
            m_DecimalDegrees = ToDecimalDegrees(_hours, _minutes, _seconds);
        }
        ...
        public Angle(int _hours, double _decimalMinutes)
        {
            m_DecimalDegrees = ToDecimalDegrees(_hours, _decimalMinutes);
        }
        ...
        /// conversion.
        /// </param>
        public Angle(string _value, CultureInfo _culture)
        {
            ...
            try
            {
                ...
                switch (values.Length)
                {
                    case 0:
                        ...
                        m_DecimalDegrees = 0.0;
                        return;
                    case 1: // Decimal degrees
                        // Is it infinity?                                        
                        if (String.Compare(values[0], Resources.Common_Infinity, true, _culture) == 0)
                        {
                        ...
                        if (values[0].Length == 7 && values[0].IndexOf(_culture.NumberFormat.NumberDecimalSeparator, StringComparison.CurrentCulture) == -1)
                        {
                            m_DecimalDegrees = ToDecimalDegrees(
                                ...
                                int.Parse(values[0].Substring(3, 2), _culture),
                            ...
                            && values[0].IndexOf(_culture.NumberFormat.NumberDecimalSeparator, StringComparison.CurrentCulture) == -1)
                        {
                            m_DecimalDegrees = ToDecimalDegrees(
                                ...
                                int.Parse(values[0].Substring(4, 2), _culture),
                                double.Parse(values[0].Substring(6, 2), _culture));
                            return;
                        }

                        m_DecimalDegrees = double.Parse(values[0], _culture);
                        return;
            ...
            {
                throw new ArgumentException(Properties.Resources.Angle_InvalidFormat, "_value", ex);
            }
        }
        ...
        {
            get { return double.IsNaN(m_DecimalDegrees); }
        }
        ...
        {
            get { return m_DecimalDegrees >= 0 && m_DecimalDegrees < 360; }
        }
        ...
        public Angle Mirror()
        {
            return new Angle(m_DecimalDegrees + 180.0).Normalize();
        }
        ...
        {
            double _Value = m_DecimalDegrees;
            while (_Value < 0)
            {
                _Value += 360.0;
            }
        ...
        {
            return new Angle(Math.Ceiling(m_DecimalDegrees));
        }

        /// <summary>Returns the largest integer which is smaller than the specified value.</summary>
        public Angle Floor()
        {
            return new Angle(Math.Floor(m_DecimalDegrees));
        }
        ...
        {
            return new Angle(Math.Round(m_DecimalDegrees, decimals));
        }
        ...
        {
            return new Angle(m_DecimalDegrees + 1.0);
        }
        ...
        {
            return m_DecimalDegrees < value.DecimalDegrees;
        }

        public bool IsLessThan(double value)
        {
            return m_DecimalDegrees < value;
        }
        ...
        public Angle Clone()
        {
            return new Angle(m_DecimalDegrees);
        }
        ...
        {
            return m_DecimalDegrees.CompareTo(other.DecimalDegrees);
        }
        ...
        {
            return m_DecimalDegrees.Equals(angle.DecimalDegrees);
        }
        ...
        {
            return Math.Round(m_DecimalDegrees, decimals).Equals(Math.Round(angle.DecimalDegrees, decimals));
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            {
                // Is it infinity?
                if (double.IsPositiveInfinity(m_DecimalDegrees))
                    return "+" + Properties.Resources.Common_Infinity;
                // Is it infinity?
                if (double.IsNegativeInfinity(m_DecimalDegrees))
                    return "-" + Properties.Resources.Common_Infinity;
                if (double.IsNaN(m_DecimalDegrees))
                    return "NaN";
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteString(m_DecimalDegrees.ToString("G17", CultureInfo.InvariantCulture));
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            */
            ...
            m_DecimalDegrees = reader.ReadElementContentAsDouble();
        }
