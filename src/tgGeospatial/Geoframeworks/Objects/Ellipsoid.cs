...
namespace TreeGecko.Library.Geospatial.Geoframeworks.Objects
{
    ...
    public sealed class Ellipsoid : IEquatable<Ellipsoid>, IXmlSerializable
    {
        ...
        public static readonly Ellipsoid AiryModified1949 = new Ellipsoid(7002, 6377340.189, 299.3249646, 0,
            "Airy Modified 1849");

        /// <summary> Represents the Australian National ellipsoid of 1965. </summary>
        public static readonly Ellipsoid AustralianNational1965 = new Ellipsoid(7003, 6378160, 298.25, 0,
        ...
        public static readonly Ellipsoid Bessel1841Mod = new Ellipsoid(7005, 6377492.018, 299.1528128, 0,
            "Bessel Modified");

        /// <summary> Represents the Bessel (Namibia) ellipsoid of 1841. </summary>
        public static readonly Ellipsoid Bessel1841Namibia = new Ellipsoid(7006, 6377483.865, 299.1528128, 0,
            "Bessel Namibia");

        /// <summary> Represents the Clarke ellipsoid of 1858. </summary>
        public static readonly Ellipsoid Clarke1858 = new Ellipsoid(7007, 20926348*0.3047972651151, 0,
            20855233*0.3047972651151, "Clarke 1858");
        ...
        public static readonly Ellipsoid Clarke1866Michigan = new Ellipsoid(7009, 20926631.53*0.3048006096012, 0,
            20855688.67*0.3048006096012, "Clarke 1866 Michigan");

        /// <summary> Represents the Clarke (Benoit) ellipsoid of 1880./// </summary>
        public static readonly Ellipsoid Clarke1880Benoit = new Ellipsoid(7010, 6378300.789, 0, 6356566.435,
            "Clarke 1880 (Benoit)");
        ...
        public static readonly Ellipsoid Clarke1880RGS = new Ellipsoid(7012, 6378249.145, 293.465, 0,
            "Clarke 1880 (RGS)");

        /// <summary> Represents the Clarke (Arc) ellipsoid of 1880./// </summary>
        public static readonly Ellipsoid Clarke1880Arc = new Ellipsoid(7013, 6378249.145, 293.4663077, 0,
            "Clarke 1880 (Arc)");

        /// <summary> Represents the Clarke (SGA 1822) ellipsoid of 1880./// </summary>
        public static readonly Ellipsoid Clarke1880SGA = new Ellipsoid(7014, 6378249.2, 293.46598, 0,
            "Clarke 1880 (SGA 1922)");

        /// <summary> Represents the Everest (1937 Adjustment) ellipsoid of 1830. </summary>
        public static readonly Ellipsoid Everest1830_37 = new Ellipsoid(7015, 6377276.345, 300.8017, 0,
            "Everest 1830 (1937 Adjustment)");

        /// <summary> Represents the Everest (1967 Definition) ellipsoid of 1830. </summary>
        public static readonly Ellipsoid Everest1830_67 = new Ellipsoid(7016, 6377298.556, 300.8017, 0,
            "Everest 1830 (1967 Definition)");

        //No 7017 in EPSG
        /// <summary> Represents the Everest (Modified 1948) ellipsoid of 1880. </summary>
        public static readonly Ellipsoid Everest1830Modified = new Ellipsoid(7018, 6377304.063, 300.8017, 0,
        ...
        public static readonly Ellipsoid Indonesian1974 = new Ellipsoid(7021, 6378160, 298.247, 0,
        ...
        public static readonly Ellipsoid Clarke1880 = new Ellipsoid(7034, 20926202*0.3047972651151, 293.465,
            20854895*0.3047972651151, "Clarke 1880");
        ...
        public static readonly Ellipsoid Ats1977 = new Ellipsoid(7041, 6378135, 298.257, 0,
            "Average Terrestrial System 1977");

        /// <summary> Represents the Everest (1830 Definition) ellipsoid. </summary>
        public static readonly Ellipsoid Everest1830 = new Ellipsoid(7042, 20922931.8*0.3047995102481, 300.8017,
            20853374.58*0.3047995102481, "Everest (1830 Definition)");
        ...
        public static readonly Ellipsoid Everest1830_62 = new Ellipsoid(7044, 6377301.243, 300.8017255, 0,
            "Everest 1830 (1962 Definition)");

        /// <summary> Represents the Everest (1975 Definition) ellipsoid of 1830. </summary>
        public static readonly Ellipsoid Everest1830_75 = new Ellipsoid(7045, 6377299.151, 300.8017255, 0,
            "Everest 1830 (1975 Definition)");

        /// <summary> Represents the Bessel (Japan) ellipsoid of 1841. </summary>
        public static readonly Ellipsoid Bessel1841Japan = new Ellipsoid(7046, 6377397.155, 299.1528128, 0,
            "Bessel Namibia (GLM)");

        //7047 depricated in EPSG
        /// <summary> Represents the GRS 1980 Authalic Sphere (r=6371007). </summary>
        public static readonly Ellipsoid GRS1980AuthalicSphere = new Ellipsoid(7048, 6371007, 0, 6371007,
        ...
        public static readonly Ellipsoid NormalSphere = new Ellipsoid(7052, 6370997, 0, 6370997,
        ...
        public static readonly Ellipsoid Clarke1880InternationalFoot = new Ellipsoid(7055, 20926202*0.3048, 0,
            20854895*0.3048, "Clarke 1880 (international foot)");

        /// <summary> Represents the Everest (RSO 1969) ellipsoid of 1880. </summary>
        public static readonly Ellipsoid Everest1880RSO = new Ellipsoid(7056, 6377295.664, 300.8017, 0,
            "Everest 1830 (RSO 1969)");

        /// <summary> Represents the International 1924 Authalic Sphere. </summary>
        public static readonly Ellipsoid International1924AuthalicSphere = new Ellipsoid(7057, 6371228, 0, 6371228,
        ...
        public static readonly Ellipsoid APL4_9 = new Ellipsoid("Appl. Physics. 1965",
            new Distance(6378137.0, DistanceUnit.Meters), 298.25);

        /// <summary> Represents the Comm. des Poids et Mesures ellipsoid of 1799./// </summary>
        public static readonly Ellipsoid CPM = new Ellipsoid("Comm. des Poids et Mesures 1799",
            new Distance(6375738.7, DistanceUnit.Meters), 334.29);

        /// <summary> Represents the Delambre (Belgium) ellipsoid of 1810./// </summary>
        public static readonly Ellipsoid Delmabre = new Ellipsoid("Delambre 1810 (Belgium)",
            new Distance(6376428, DistanceUnit.Meters), 311.5);

        /// <summary> Represents the Engelis ellipsoid of 1985./// </summary>
        public static readonly Ellipsoid Engelis = new Ellipsoid("Engelis 1985",
            new Distance(6376428, DistanceUnit.Meters), 311.5);

        /// <summary> Represents the Fisher ellipsoid of 1960. </summary>
        public static readonly Ellipsoid Fischer1960 = new Ellipsoid("Fisher (Mercury Datum) 1960",
            new Distance(6378166.0, DistanceUnit.Meters), new Distance(6356784.283666, DistanceUnit.Meters));

        /// <summary> Represents the Modified Fisher ellipsoid of 1960. </summary>
        public static readonly Ellipsoid ModifiedFischer1960 = new Ellipsoid("Modified Fisher 1960",
            new Distance(6378155.0, DistanceUnit.Meters), new Distance(6356773.3205, DistanceUnit.Meters));

        /// <summary> Represents the Fisher ellipsoid of 1968. </summary>
        public static readonly Ellipsoid Fischer1968 = new Ellipsoid("Fisher 1968",
            new Distance(6378150.0, DistanceUnit.Meters), new Distance(6356768.337303, DistanceUnit.Meters));

        /// <summary> Represents the New International ellipsoid of 1967. </summary>
        public static readonly Ellipsoid NewInternational1967 = new Ellipsoid("New International 1967",
            new Distance(6378157.5, DistanceUnit.Meters), new Distance(6356772.2, DistanceUnit.Meters));

        /// <summary> Represents the Kaula ellipsoid of 1961. </summary>
        public static readonly Ellipsoid Kaula = new Ellipsoid("Kaula 1961",
            new Distance(6378163.0, DistanceUnit.Meters), 298.24);

        /// <summary> Represents the Lerch ellipsoid of 1979. </summary>
        public static readonly Ellipsoid Lerch = new Ellipsoid("Lerch 1979",
            new Distance(6378139.0, DistanceUnit.Meters), 298.257);

        /// <summary> Represents the MERIT ellipsoid of 1983. </summary>
        public static readonly Ellipsoid Merit = new Ellipsoid("Merit 1983",
            new Distance(6378137.0, DistanceUnit.Meters), 298.257);

        /// <summary> Represents the Maupertius ellipsoid of 1738. </summary>
        public static readonly Ellipsoid Maupertius = new Ellipsoid("Maupertius 1738",
            new Distance(639730.0, DistanceUnit.Meters), 191);

        /// <summary> Represents the Southeast Asia (Modified Fisher ellipsoid of 1960) ellipsoid. </summary>
        public static readonly Ellipsoid SoutheastAsia = new Ellipsoid("Southeast Asia",
            new Distance(6378155.0, DistanceUnit.Meters), new Distance(6356773.3205, DistanceUnit.Meters));

        /// <summary> Represents the SGS ellipsoid of 1985. </summary>
        public static readonly Ellipsoid Sgs1985 = new Ellipsoid("SGS 85", new Distance(6378136.0, DistanceUnit.Meters),
            new Distance(6356751.301569, DistanceUnit.Meters));

        /// <summary> Represents the South American ellipsoid of 1969. </summary>
        public static readonly Ellipsoid SouthAmerican1969 = new Ellipsoid("South American 1969",
            new Distance(6378160.0, DistanceUnit.Meters), new Distance(6356774.719, DistanceUnit.Meters));

        /// <summary> Represents the Walbeck ellipsoid. </summary>
        public static readonly Ellipsoid Walbeck = new Ellipsoid("Walbeck", new Distance(6376896.0, DistanceUnit.Meters),
            new Distance(6355834.8467, DistanceUnit.Meters));

        /// <summary> Represents the World Geodetic System ellipsoid of 1960. </summary>
        public static readonly Ellipsoid Wgs1960 = new Ellipsoid("WGS 60", new Distance(6378165.0, DistanceUnit.Meters),
            new Distance(6356783.286959, DistanceUnit.Meters));

        /// <summary> Represents the World Geodetic System ellipsoid of 1966. </summary>
        public static readonly Ellipsoid Wgs1966 = new Ellipsoid("WGS 1966",
            new Distance(6378145.0, DistanceUnit.Meters), new Distance(6356759.769356, DistanceUnit.Meters));
        ...
        {
            if ((_EquatorialRadius.IsEmpty && _InverseFlattening == 0) ||
                (_EquatorialRadius.IsEmpty && _PolarRadius.IsEmpty))
                throw new ArgumentException(
                    "The radii and inverse flattening of an allipsoid cannot be zero.   Please specify either the equatorial and polar radius, or the equatorial radius and the inverse flattening for this ellipsoid.");
        }
        ...
        private void Calculate()
        {
            ...
            _Flattening = (_EquatorialRadius.ToMeters().Value - _PolarRadius.ToMeters().Value)/
                          _EquatorialRadius.ToMeters().Value;
            _InverseFlattening = 1.0/_Flattening;
            _Eccentricity =
                Math.Sqrt((Math.Pow(_EquatorialRadius.Value, 2) - Math.Pow(_PolarRadius.Value, 2))/
                          Math.Pow(_EquatorialRadius.Value, 2));
        ...
        {
            get { return _EccentricitySquared; }
        }
        ...
        {
            get { return _PolarRadiusMeters; }
        }

        internal double EquatorialRadiusMeters
        {
            get { return _EquatorialRadiusMeters; }
        }
