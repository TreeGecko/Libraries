...
using TreeGecko.Library.Geospatial.Geoframeworks.Helpers;
...
namespace TreeGecko.Library.Geospatial.Geoframeworks.Objects
{
    ...
    public sealed class Matrix : IDisposable, IEquatable<Matrix>, ICloneable<Matrix>
    {
        ...
        /// </summary>
        /// <param name="_angle"> Amount, in degrees, to rotate. </param>
        /// <param name="_point"> The desired center of rotation. </param>
        public void RotateAt(float _angle, PointF _point)
        {
            this.RotateAt(_angle, _point, MatrixOrder.Prepend);
        }
        ...
        /// <param name="_point"> The desired center of rotation. </param>
        /// <param name="matrixOrder"> The order in which to carry out the operation. </param>
        public void RotateAt(float _angle, PointF _point, MatrixOrder matrixOrder)
        {
            // Create the offset rotstion independant of our current matrix
            Matrix rotation = new Matrix();
            rotation.Translate(-_point.X, -_point.Y, MatrixOrder.Append);
            rotation.Rotate(_angle, MatrixOrder.Append);
            rotation.Translate(_point.X, _point.Y, MatrixOrder.Append);
